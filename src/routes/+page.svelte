...
<div class="flex h-[80%] w-full items-center">
	...
	<section class="flex w-full flex-col items-center px-[150px]">
		...
		{:else}
			...
			<div class="flex w-full flex-col gap-8">
				...
				<Input
					type="password"
					placeholder="Avail Engglib services using SUSê by tapping your RFID!"
					class="h-[55px] max-w-full text-base"
				/>
			</div>
